...
<div class="w3-container">
        ...
        <form action="AddpromotionToDb.jsp" style="width: 40%; background-color: white;border: 1px solid whitesmoke; padding: 10px;box-shadow: 
        rgba(100, 100, 111, 0.2) 0px 7px 29px 0px; border-radius: 10px;">
            
            
        <div style="display: flex;align-items: center; justify-content: center;">
            <h5 style="align-items: center;">Register items</h5>
            <a href="ApprovedMaterials.jsp" title="view coordinator" style="margin-left: 10px;margin-top: 5px; border: 1px solid black;background-color: blue;color: white;">View Promotional</a>
        </div>
            ...
            <div class="m-3">
              ...
              <div class="m-3 "  style="margin:20px 0;">
                  <button type="submit" class="btn btn-primary pt-3 m-2 btn-block">Register Items</button>
              </div>
